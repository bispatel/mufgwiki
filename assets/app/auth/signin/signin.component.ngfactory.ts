...
export function viewFactory_SignInComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.SignInComponent> {
  if ((renderType_SignInComponent === (null as any))) { (renderType_SignInComponent = viewUtils.createRenderComponentType('D:/read/UDEMY-MEAN/Mongo/angularApp/assets/app/auth/signin.component.html',0,import10.ViewEncapsulation.None,styles_SignInComponent,{})); }
